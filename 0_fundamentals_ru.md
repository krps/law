...
## 2.12. В случае нехватки ресурсов в природе, владелец запасов добытого сырья обязан передать полагающуюся часть. В противном случае, допустимо правомерное возмездие. Продукты, назначением которых является хранения сырья, рассматриваются как сырьё
...
### 3.1.4. Автор может определить принцип совместимости ревизий документа
### 3.1.5. Новая ревизия не означает автоматическое принятие ранее подписавшимися
...
### 3.2.2. Субъект права может наделить правом действовать от своего лица иной субъект, не передавая власть при этом
...
## 3.3. Экономика
### 3.3.1. Конфедерация не имеет целостной экономики - допускаются различные добровольные формы среди её членов.
### 3.3.2. Сама Конфедерация не имеет обязанностей и не предоставляет никаких условно бесплатных сервисов
### 3.3.3. Недопустима никакая форма принудительного налога и навязывания услуг. Возможна лишь добровольная оплата с целью получения доступа к конкретной сфере услуг (медицина, спасательная служба, защита и т.д.) государства.
...
### 3.4.1. Официальный Герб, Гимн, Флаг и прочие элементы могут быть определены в последующих ревизиях. До тех пор действует лишь официальное название

## 3.5. Язык и культура
### 3.5.1. Конфедерация не определяет официального "национального" языка и культуры.
### 3.5.2. Данный устав составлен на русском и английском языках
...
### 3.6.2. Конфедерация не имеет единого властного или представительского органа. Никто не в праве выступать и заключать договора от имени Конфедерации
### 3.6.3. Члена Конфедерации самостоятельно, либо добровольно объединившись, выступают на международный арене
...
### 3.8.8. Степень берётся самостоятельно по версии учебного заведения. Неправомерное присвоение расценивается как распространение недостоверной информации
...
## 4.4. Допусти технические ревизии с третьим числом для исправления ошибок, но не меняющих сути
## 4.5. Черновики не являются ревизией документа

# 5. Порядок принятия документа
